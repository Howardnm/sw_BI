...
class SalesIndicator(models.Model):
    ...
    target_sales_volume_1 = models.IntegerField(verbose_name="1月销量指标(吨)", default=0)
    target_sales_volume_2 = models.IntegerField(verbose_name="2月销量指标(吨)", default=0)
    target_sales_volume_3 = models.IntegerField(verbose_name="3月销量指标(吨)", default=0)
    target_sales_volume_4 = models.IntegerField(verbose_name="4月销量指标(吨)", default=0)
    target_sales_volume_5 = models.IntegerField(verbose_name="5月销量指标(吨)", default=0)
    target_sales_volume_6 = models.IntegerField(verbose_name="6月销量指标(吨)", default=0)
    target_sales_volume_7 = models.IntegerField(verbose_name="7月销量指标(吨)", default=0)
    target_sales_volume_8 = models.IntegerField(verbose_name="8月销量指标(吨)", default=0)
    target_sales_volume_9 = models.IntegerField(verbose_name="9月销量指标(吨)", default=0)
    target_sales_volume_10 = models.IntegerField(verbose_name="10月销量指标(吨)", default=0)
    target_sales_volume_11 = models.IntegerField(verbose_name="11月销量指标(吨)", default=0)
    target_sales_volume_12 = models.IntegerField(verbose_name="12月销量指标(吨)", default=0)
    target_sales_revenue_1 = models.IntegerField(verbose_name="1月销售额指标(万元)", default=0)
    target_sales_revenue_2 = models.IntegerField(verbose_name="2月销售额指标(万元)", default=0)
    target_sales_revenue_3 = models.IntegerField(verbose_name="3月销售额指标(万元)", default=0)
    target_sales_revenue_4 = models.IntegerField(verbose_name="4月销售额指标(万元)", default=0)
    target_sales_revenue_5 = models.IntegerField(verbose_name="5月销售额指标(万元)", default=0)
    target_sales_revenue_6 = models.IntegerField(verbose_name="6月销售额指标(万元)", default=0)
    target_sales_revenue_7 = models.IntegerField(verbose_name="7月销售额指标(万元)", default=0)
    target_sales_revenue_8 = models.IntegerField(verbose_name="8月销售额指标(万元)", default=0)
    target_sales_revenue_9 = models.IntegerField(verbose_name="9月销售额指标(万元)", default=0)
    target_sales_revenue_10 = models.IntegerField(verbose_name="10月销售额指标(万元)", default=0)
    target_sales_revenue_11 = models.IntegerField(verbose_name="11月销售额指标(万元)", default=0)
    target_sales_revenue_12 = models.IntegerField(verbose_name="12月销售额指标(万元)", default=0)
